...
![align](images/diversity-figure.png){width="1000"}
...
For the processed amplicon sequuence data (see analyses), phyloNEON also includes functions to convert downloaded NEON metabarcoding data to the [phyloseq package](https://joey711.github.io/phyloseq/) format.
...
![align](images/phyloNEON_logo2.png){width="1000"}
